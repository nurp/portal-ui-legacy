        ...
        (function (services) {
            ...
            var SearchService = (function () {
                ...
                SearchService.prototype.getSummary = function (filters, ignoreUserProjects) {
                    ...
                    return this.Restangular.all("ui/search/summary").post({ filters: filters }, undefined, { 'Content-Type': 'application/json' }).then(function (response) {
                        return response;
                    });
                };
            ...
            angular.module("search.services", []).service("SearchState", State).service("SearchChartConfigs", SearchChartConfigs).service("SearchService", SearchService);
