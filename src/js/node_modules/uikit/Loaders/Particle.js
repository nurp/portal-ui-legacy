...
const Particle = () => (
  <div style={styles.spinParticleContainer}>
    <div style={{ ...styles.particle, ...styles.red }} />
    <div style={{ ...styles.particle, ...styles.otherParticle, ...styles.grey }} />
    <div style={{ ...styles.particle, ...styles.otherOtherParticle, ...styles.blue }} />
  </div>
);
